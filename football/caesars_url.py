...
# init logging
logger_name = environ.get('football_caesars_url_get_logger', 'football_caesars_url_logger')
# for local logs storage and stdout use DEBUG_FLAG = 1
DEBUG_FLAG = environ.get('football_caesars_url_DEBUG_FLAG', 0)
log_level = environ.get('football_caesars_url_log_level', 'WARNING')

logger = get_logger(logger_name, DEBUG_FLAG, log_level)

# other variables
URL = environ.get('football_caesars_url', module_conf.get('URL'))
module_work_duration = str_to_timedelta(environ.get('football_caesars_url_module_work_duration', module_conf.get('module_work_duration')))
update_frequency = str_to_timedelta(environ.get('football_caesars_url_update_frequency', module_conf.get('update_frequency')))
browser = environ.get('football_caesars_url_browser', module_conf.get('browser_url'))
        ...
        try:
            ...
            try:
                ...
                for rd_url in urls_list:
                    ...
                    saving_result = add_url_redis(rd_url, 'caesars', f'football_caesars_prop_{stream_name}')
